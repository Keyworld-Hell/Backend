...
@Service
public class SwitchLockService {

    @Autowired
    private SwitchLockRepository repository;

    public List<SwitchLock> getAll() {
        return repository.findAll();
    }

    public List<SwitchLock> findSwitchLocksByTitle(String title) {
        return repository.findByTitleContainingIgnoreCase(title);
    }
    public byte[] getByIdAndFileIndex(Long id, int fileIndex) {
        SwitchLock entity = getById(id);
        switch (fileIndex) {
            case 1:
    ...
    public SwitchLock getById(Long id) {
        return repository.findById(id)
                .orElseThrow(() -> new ResourceNotFoundException());
    }


    public SwitchLock save(SwitchLockDTO dto) throws IOException {
        SwitchLock entity = new SwitchLock();
    ...
    public SwitchLock update(Long id, SwitchLockDTO dto) throws IOException {
        SwitchLock entity = getById(id);
        entity.setTitle(dto.getTitle());
        entity.setMaterial(dto.getMaterial());
        entity.setSurface(dto.getSurface());
